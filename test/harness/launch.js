...
async function tryLaunch(browserPath, extDir) {
  ...
  const context = await chromium.launchPersistentContext(userDataDir, {
    ...
    args: [
      ...
      "--host-resolver-rules=MAP e2e-flagged.example 127.0.0.1, MAP e2e-redirector.example 127.0.0.1, MAP e2e-soft.example 127.0.0.1, MAP e2e-doc.example 127.0.0.1",
    ],
  });
